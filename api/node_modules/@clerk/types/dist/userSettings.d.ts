import type { ClerkResourceJSON } from '@clerk/types/src/json';
import type { ClerkResource } from '@clerk/types/src/resource';
import type { OAuthStrategy, Web3Strategy } from '@clerk/types/src/strategies';
export type Attribute = 'email_address' | 'phone_number' | 'username' | 'first_name' | 'last_name' | 'password' | 'web3_wallet' | 'authenticator_app' | 'backup_code' | 'passkey';
