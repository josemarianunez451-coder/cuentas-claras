import type { BirthdayAttribute, FirstNameAttribute, GenderAttribute, LastNameAttribute, PasswordAttribute } from '@clerk/types/src/attributes';
import type { AttemptEmailAddressVerificationParams, PrepareEmailAddressVerificationParams } from '@clerk/types/src/emailAddress';
import type { EmailAddressIdentifier, EmailAddressOrPhoneNumberIdentifier, PhoneNumberIdentifier, UsernameIdentifier, Web3WalletIdentifier } from '@clerk/types/src/identifiers';
import type { ValidatePasswordCallbacks } from '@clerk/types/src/passwords';
import type { AttemptPhoneNumberVerificationParams, PreparePhoneNumberVerificationParams } from '@clerk/types/src/phoneNumber';
...
import type { EmailCodeStrategy, EmailLinkStrategy, GoogleOneTapStrategy, OAuthStrategy, PhoneCodeStrategy, SamlStrategy, TicketStrategy, Web3Strategy } from '@clerk/types/src/strategies';
...
import type { AttemptWeb3WalletVerificationParams, AuthenticateWithWeb3Params } from '@clerk/types/src/web3Wallet';
declare global {
    /**
